    ...
    >
      ...
      <div className="auth__card">
        <div className="auth__header">
          ...
          <p className="auth__subtitle">Sign in to continue planning your trips</p>
        </div>
        ...
        <div className="auth__footer">
          <p>Don't have an account? <Link to="/register" className="auth__link">Sign up</Link></p>
          <p className="auth__hint">💡 Use any email/password to register and login</p>
        </div>
      </div>
    </motion.div>
  )
